...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/app/vendor/foundation-sites/dist/foundation.min.js":[function(require,module,exports) {
var define;
...
!function (t) {
  ...
  var i = function i(t, e, _i, s) {
      ...
      var u = [a, o, r, l];
      return _i ? r === l == !0 : s ? o === a == !0 : -1 === u.indexOf(!1);
    },
    n = function n(t, i) {
      ...
      switch (i) {
        ...
        case "reveal":
          return {
            ...
            top: r.windowDims.offset.top + _s
          };
        case "reveal full":
          return {
  ...
  var o = {},
    a = function a(i, n, _a) {
      var r,
        ...
        h = o[n],
        u = s(i);
      return h ? (r = "undefined" == typeof h.ltr ? h : e.rtl() ? t.extend({}, h.ltr, h.rtl) : t.extend({}, h.rtl, h.ltr), l = r[u], d = _a[l], void (d && "function" == typeof d ? (d.apply(), (_a.handled || "function" == typeof _a.handled) && _a.handled.apply()) : (_a.unhandled || "function" == typeof _a.unhandled) && _a.unhandled.apply())) : console.warn("Component not defined!");
    };
  ...
  var s = function s(t) {
      ...
      if (t && ("string" == typeof t ? n.push(t) : "object" == _typeof(t) && "string" == typeof t[0] ? n.concat(t) : console.error("Plugin names must be strings")), i.length) {
  ...
  i.defaults = {
    ...
    (this.options.clickOpen || n) && this.$menuItems.on("click.zf.dropdownmenu touchstart.zf.dropdownmenu", function (e) {
      ...
      var n = t(this),
        o = n.hasClass(s);
      o && (clearTimeout(i.delay), i.delay = setTimeout(function () {
        i._show(n.children(".is-dropdown-submenu"));
      }, i.options.hoverDelay));
    }).on("mouseleave.zf.dropdownmenu", function (e) {
      var n = t(this),
        o = n.hasClass(s);
      if (o && i.options.autoclose) {
  ...
  i.defaults = {
    ...
    if (this._setValues(t, i), a) {
      var y,
        ...
        b = ~~(100 * n(f, p));
      if ($) w[c] = v + "%", y = parseFloat(this.$handle2[0].style[c]) - v + b, o && "function" == typeof o && o();else {
        var C = parseFloat(this.$handle[0].style[c]);
        y = v - (isNaN(C) ? this.options.initialStart : C) + b;
      }
      w["min-" + u] = y + "%";
    }
    ...
    if (o) a = o, r = !0;else {
      ...
      if (a = (this.options.end - this.options.start) * g, e.rtl() && !this.options.vertical && (a = this.options.end - a), r = !1, !i) {
        var v = s(this.$handle, h, m, d),
          w = s(this.$handle2, h, m, d);
        i = w >= v ? this.$handle : this.$handle2;
      }
    }
    ...
    if (this.inputs.off("change.zf.slider").on("change.zf.slider", function (e) {
      ...
      return s.$element.data("dragging") ? !1 : void (s.options.doubleSided ? s._handleEvent(t) : s._handleEvent(t, s.$handle));
  ...
  i.defaults = {
    ...
    var e;
    e = "object" == _typeof(t) ? t[0].id : t, e.indexOf("#") < 0 && (e = "#" + e);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/app/vendor/foundation-sites/dist/foundation.min.js"], null)
//# sourceMappingURL=/foundation.min.f37f1fec.js.map